...
class Tacotron2(nn.Module):
    def __init__(self, hparams):
        ...
        self.gst = GST()
        self.ser = SER()
        # self.ser.load_state_dict(torch.load(config.pretrain_ser_path))
    ...
    def forward(self, inputs):
        ...
        ref_mels = mels
        # TODO
        if (config.use_neutral):
            style_embed = self.gst(ref_mels)  # [N, 256]
        else:
            style_embed, _ = self.ser(ref_mels)
